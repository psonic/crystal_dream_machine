...
from components.audio_processor import (
    add_audio_to_video, load_audio_analysis, get_audio_reactive_factors,
    get_organic_deformation_factors, load_audio_wrapper
)
from components.svg_pdf_processor import (
    get_svg_dimensions, extract_contours_from_svg, extract_contours_from_svg_fallback,
    extract_contours_from_pdf, load_logo_contours
)
